...
const FilteringReportingCustomersModal = () => (
  <Wrapper>
    ...
    <Form className="filtering">
      ...
      <Row>
        <Label text="Start Reg Date" inputId="start-date" content={{} as any} />
        <DatePicker />
      </Row>
      <Row>
        <Label text="End Reg Date" inputId="end-date" content={{} as any} />
        <DatePicker />
      </Row>
      <Row>
      ...
      <Row>
        <Label text="Postcode" inputId="post-code" content={{} as any} />
        <Input name="post-code" id="post-code" placeholder="Postcode" />
      </Row>
      <Row>
        <Label text="Customer Approved" inputId="customer-approved" content={{} as any} />
        <Select options={[]} />
      </Row>
      <Row>
        <Label text="Customer Newsletter" inputId="customer-newsletter" content={{} as any} />
        <Select options={[]} />
      </Row>
      <Row>
        <Label text="Customer Marketing Emails" inputId="customer-marketing" content={{} as any} />
        <Select options={[]} id="customer-marketing" />
      </Row>
      <Row>
        <Label text="Registered on class lists" inputId="customer-classlist" content={{} as any} />
        <Select options={[]} id="customer-classlist" />
      </Row>
      <Row className="last">
        <Label text="Guest Customer" inputId="guest-customer" content={{} as any} />
