...
interface QuestionIconOutlineProps {
  className?: string;
}

const QuestionIconOutline = ({ className }: QuestionIconOutlineProps) => (
...
QuestionIconOutline.defaultProps = {
  className: '',
};

export default QuestionIconOutline;
